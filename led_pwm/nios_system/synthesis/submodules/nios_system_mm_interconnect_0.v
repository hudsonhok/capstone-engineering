...
module nios_system_mm_interconnect_0 (
		...
		output wire        motor_ip_avalon_slave_write,                              //                              motor_ip_avalon_slave.write
		output wire        motor_ip_avalon_slave_read,                               //                                                   .read
		input  wire [31:0] motor_ip_avalon_slave_readdata,                           //                                                   .readdata
		output wire [31:0] motor_ip_avalon_slave_writedata,                          //                                                   .writedata
	...
	wire   [31:0] motor_ip_avalon_slave_agent_m0_readdata;                                            // motor_ip_avalon_slave_translator:uav_readdata -> motor_ip_avalon_slave_agent:m0_readdata
	wire          motor_ip_avalon_slave_agent_m0_waitrequest;                                         // motor_ip_avalon_slave_translator:uav_waitrequest -> motor_ip_avalon_slave_agent:m0_waitrequest
	wire          motor_ip_avalon_slave_agent_m0_debugaccess;                                         // motor_ip_avalon_slave_agent:m0_debugaccess -> motor_ip_avalon_slave_translator:uav_debugaccess
	wire   [28:0] motor_ip_avalon_slave_agent_m0_address;                                             // motor_ip_avalon_slave_agent:m0_address -> motor_ip_avalon_slave_translator:uav_address
	wire    [3:0] motor_ip_avalon_slave_agent_m0_byteenable;                                          // motor_ip_avalon_slave_agent:m0_byteenable -> motor_ip_avalon_slave_translator:uav_byteenable
	wire          motor_ip_avalon_slave_agent_m0_read;                                                // motor_ip_avalon_slave_agent:m0_read -> motor_ip_avalon_slave_translator:uav_read
	wire          motor_ip_avalon_slave_agent_m0_readdatavalid;                                       // motor_ip_avalon_slave_translator:uav_readdatavalid -> motor_ip_avalon_slave_agent:m0_readdatavalid
	wire          motor_ip_avalon_slave_agent_m0_lock;                                                // motor_ip_avalon_slave_agent:m0_lock -> motor_ip_avalon_slave_translator:uav_lock
	wire   [31:0] motor_ip_avalon_slave_agent_m0_writedata;                                           // motor_ip_avalon_slave_agent:m0_writedata -> motor_ip_avalon_slave_translator:uav_writedata
	wire          motor_ip_avalon_slave_agent_m0_write;                                               // motor_ip_avalon_slave_agent:m0_write -> motor_ip_avalon_slave_translator:uav_write
	wire    [2:0] motor_ip_avalon_slave_agent_m0_burstcount;                                          // motor_ip_avalon_slave_agent:m0_burstcount -> motor_ip_avalon_slave_translator:uav_burstcount
	wire          motor_ip_avalon_slave_agent_rf_source_valid;                                        // motor_ip_avalon_slave_agent:rf_source_valid -> motor_ip_avalon_slave_agent_rsp_fifo:in_valid
	wire  [105:0] motor_ip_avalon_slave_agent_rf_source_data;                                         // motor_ip_avalon_slave_agent:rf_source_data -> motor_ip_avalon_slave_agent_rsp_fifo:in_data
	wire          motor_ip_avalon_slave_agent_rf_source_ready;                                        // motor_ip_avalon_slave_agent_rsp_fifo:in_ready -> motor_ip_avalon_slave_agent:rf_source_ready
	wire          motor_ip_avalon_slave_agent_rf_source_startofpacket;                                // motor_ip_avalon_slave_agent:rf_source_startofpacket -> motor_ip_avalon_slave_agent_rsp_fifo:in_startofpacket
	wire          motor_ip_avalon_slave_agent_rf_source_endofpacket;                                  // motor_ip_avalon_slave_agent:rf_source_endofpacket -> motor_ip_avalon_slave_agent_rsp_fifo:in_endofpacket
	wire          motor_ip_avalon_slave_agent_rsp_fifo_out_valid;                                     // motor_ip_avalon_slave_agent_rsp_fifo:out_valid -> motor_ip_avalon_slave_agent:rf_sink_valid
	wire  [105:0] motor_ip_avalon_slave_agent_rsp_fifo_out_data;                                      // motor_ip_avalon_slave_agent_rsp_fifo:out_data -> motor_ip_avalon_slave_agent:rf_sink_data
	wire          motor_ip_avalon_slave_agent_rsp_fifo_out_ready;                                     // motor_ip_avalon_slave_agent:rf_sink_ready -> motor_ip_avalon_slave_agent_rsp_fifo:out_ready
	wire          motor_ip_avalon_slave_agent_rsp_fifo_out_startofpacket;                             // motor_ip_avalon_slave_agent_rsp_fifo:out_startofpacket -> motor_ip_avalon_slave_agent:rf_sink_startofpacket
	wire          motor_ip_avalon_slave_agent_rsp_fifo_out_endofpacket;                               // motor_ip_avalon_slave_agent_rsp_fifo:out_endofpacket -> motor_ip_avalon_slave_agent:rf_sink_endofpacket
	wire          cmd_mux_001_src_valid;                                                              // cmd_mux_001:src_valid -> motor_ip_avalon_slave_agent:cp_valid
	wire  [104:0] cmd_mux_001_src_data;                                                               // cmd_mux_001:src_data -> motor_ip_avalon_slave_agent:cp_data
	wire          cmd_mux_001_src_ready;                                                              // motor_ip_avalon_slave_agent:cp_ready -> cmd_mux_001:src_ready
	wire    [6:0] cmd_mux_001_src_channel;                                                            // cmd_mux_001:src_channel -> motor_ip_avalon_slave_agent:cp_channel
	wire          cmd_mux_001_src_startofpacket;                                                      // cmd_mux_001:src_startofpacket -> motor_ip_avalon_slave_agent:cp_startofpacket
	wire          cmd_mux_001_src_endofpacket;                                                        // cmd_mux_001:src_endofpacket -> motor_ip_avalon_slave_agent:cp_endofpacket
	...
	wire    [6:0] cmd_mux_002_src_channel;                                                            // cmd_mux_002:src_channel -> performance_counter_0_control_slave_agent:cp_channel
	...
	wire    [6:0] cmd_mux_004_src_channel;                                                            // cmd_mux_004:src_channel -> new_sdram_controller_0_s1_agent:cp_channel
	...
	wire  [104:0] cmd_mux_006_src_data;                                                               // cmd_mux_006:src_data -> leds_s1_agent:cp_data
	...
	wire          motor_ip_avalon_slave_agent_rp_valid;                                               // motor_ip_avalon_slave_agent:rp_valid -> router_003:sink_valid
	wire  [104:0] motor_ip_avalon_slave_agent_rp_data;                                                // motor_ip_avalon_slave_agent:rp_data -> router_003:sink_data
	wire          motor_ip_avalon_slave_agent_rp_ready;                                               // router_003:sink_ready -> motor_ip_avalon_slave_agent:rp_ready
	wire          motor_ip_avalon_slave_agent_rp_startofpacket;                                       // motor_ip_avalon_slave_agent:rp_startofpacket -> router_003:sink_startofpacket
	wire          motor_ip_avalon_slave_agent_rp_endofpacket;                                         // motor_ip_avalon_slave_agent:rp_endofpacket -> router_003:sink_endofpacket
	...
	wire  [104:0] leds_s1_agent_rp_data;                                                              // leds_s1_agent:rp_data -> router_008:sink_data
	...
	wire          motor_ip_avalon_slave_agent_rdata_fifo_src_valid;                                   // motor_ip_avalon_slave_agent:rdata_fifo_src_valid -> avalon_st_adapter_001:in_0_valid
	wire   [33:0] motor_ip_avalon_slave_agent_rdata_fifo_src_data;                                    // motor_ip_avalon_slave_agent:rdata_fifo_src_data -> avalon_st_adapter_001:in_0_data
	wire          motor_ip_avalon_slave_agent_rdata_fifo_src_ready;                                   // avalon_st_adapter_001:in_0_ready -> motor_ip_avalon_slave_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_001_out_0_valid;                                                  // avalon_st_adapter_001:out_0_valid -> motor_ip_avalon_slave_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_001_out_0_data;                                                   // avalon_st_adapter_001:out_0_data -> motor_ip_avalon_slave_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_001_out_0_ready;                                                  // motor_ip_avalon_slave_agent:rdata_fifo_sink_ready -> avalon_st_adapter_001:out_0_ready
	wire    [0:0] avalon_st_adapter_001_out_0_error;                                                  // avalon_st_adapter_001:out_0_error -> motor_ip_avalon_slave_agent:rdata_fifo_sink_error
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) motor_ip_avalon_slave_translator (
		.clk                    (sys_sdram_pll_0_sys_clk_clk),                    //                      clk.clk
		.reset                  (nios2_gen2_0_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (motor_ip_avalon_slave_agent_m0_address),         // avalon_universal_slave_0.address
		.uav_burstcount         (motor_ip_avalon_slave_agent_m0_burstcount),      //                         .burstcount
		.uav_read               (motor_ip_avalon_slave_agent_m0_read),            //                         .read
		.uav_write              (motor_ip_avalon_slave_agent_m0_write),           //                         .write
		.uav_waitrequest        (motor_ip_avalon_slave_agent_m0_waitrequest),     //                         .waitrequest
		.uav_readdatavalid      (motor_ip_avalon_slave_agent_m0_readdatavalid),   //                         .readdatavalid
		.uav_byteenable         (motor_ip_avalon_slave_agent_m0_byteenable),      //                         .byteenable
		.uav_readdata           (motor_ip_avalon_slave_agent_m0_readdata),        //                         .readdata
		.uav_writedata          (motor_ip_avalon_slave_agent_m0_writedata),       //                         .writedata
		.uav_lock               (motor_ip_avalon_slave_agent_m0_lock),            //                         .lock
		.uav_debugaccess        (motor_ip_avalon_slave_agent_m0_debugaccess),     //                         .debugaccess
		.av_write               (motor_ip_avalon_slave_write),                    //      avalon_anti_slave_0.write
		.av_read                (motor_ip_avalon_slave_read),                     //                         .read
		.av_readdata            (motor_ip_avalon_slave_readdata),                 //                         .readdata
		.av_writedata           (motor_ip_avalon_slave_writedata),                //                         .writedata
	...
	altera_merlin_slave_agent #(
		...
		.USE_WRITERESPONSE         (0),
		.ECC_ENABLE                (0)
	) motor_ip_avalon_slave_agent (
		.clk                     (sys_sdram_pll_0_sys_clk_clk),                            //             clk.clk
		.reset                   (nios2_gen2_0_reset_reset_bridge_in_reset_reset),         //       clk_reset.reset
		.m0_address              (motor_ip_avalon_slave_agent_m0_address),                 //              m0.address
		.m0_burstcount           (motor_ip_avalon_slave_agent_m0_burstcount),              //                .burstcount
		.m0_byteenable           (motor_ip_avalon_slave_agent_m0_byteenable),              //                .byteenable
		.m0_debugaccess          (motor_ip_avalon_slave_agent_m0_debugaccess),             //                .debugaccess
		.m0_lock                 (motor_ip_avalon_slave_agent_m0_lock),                    //                .lock
		.m0_readdata             (motor_ip_avalon_slave_agent_m0_readdata),                //                .readdata
		.m0_readdatavalid        (motor_ip_avalon_slave_agent_m0_readdatavalid),           //                .readdatavalid
		.m0_read                 (motor_ip_avalon_slave_agent_m0_read),                    //                .read
		.m0_waitrequest          (motor_ip_avalon_slave_agent_m0_waitrequest),             //                .waitrequest
		.m0_writedata            (motor_ip_avalon_slave_agent_m0_writedata),               //                .writedata
		.m0_write                (motor_ip_avalon_slave_agent_m0_write),                   //                .write
		.rp_endofpacket          (motor_ip_avalon_slave_agent_rp_endofpacket),             //              rp.endofpacket
		.rp_ready                (motor_ip_avalon_slave_agent_rp_ready),                   //                .ready
		.rp_valid                (motor_ip_avalon_slave_agent_rp_valid),                   //                .valid
		.rp_data                 (motor_ip_avalon_slave_agent_rp_data),                    //                .data
		.rp_startofpacket        (motor_ip_avalon_slave_agent_rp_startofpacket),           //                .startofpacket
		...
		.rf_sink_ready           (motor_ip_avalon_slave_agent_rsp_fifo_out_ready),         //         rf_sink.ready
		.rf_sink_valid           (motor_ip_avalon_slave_agent_rsp_fifo_out_valid),         //                .valid
		.rf_sink_startofpacket   (motor_ip_avalon_slave_agent_rsp_fifo_out_startofpacket), //                .startofpacket
		.rf_sink_endofpacket     (motor_ip_avalon_slave_agent_rsp_fifo_out_endofpacket),   //                .endofpacket
		.rf_sink_data            (motor_ip_avalon_slave_agent_rsp_fifo_out_data),          //                .data
		.rf_source_ready         (motor_ip_avalon_slave_agent_rf_source_ready),            //       rf_source.ready
		.rf_source_valid         (motor_ip_avalon_slave_agent_rf_source_valid),            //                .valid
		.rf_source_startofpacket (motor_ip_avalon_slave_agent_rf_source_startofpacket),    //                .startofpacket
		.rf_source_endofpacket   (motor_ip_avalon_slave_agent_rf_source_endofpacket),      //                .endofpacket
		.rf_source_data          (motor_ip_avalon_slave_agent_rf_source_data),             //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_001_out_0_ready),                      // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_001_out_0_valid),                      //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_001_out_0_data),                       //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_001_out_0_error),                      //                .error
		.rdata_fifo_src_ready    (motor_ip_avalon_slave_agent_rdata_fifo_src_ready),       //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (motor_ip_avalon_slave_agent_rdata_fifo_src_valid),       //                .valid
		.rdata_fifo_src_data     (motor_ip_avalon_slave_agent_rdata_fifo_src_data),        //                .data
		.m0_response             (2'b00),                                                  //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                                    //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) motor_ip_avalon_slave_agent_rsp_fifo (
		.clk               (sys_sdram_pll_0_sys_clk_clk),                            //       clk.clk
		.reset             (nios2_gen2_0_reset_reset_bridge_in_reset_reset),         // clk_reset.reset
		.in_data           (motor_ip_avalon_slave_agent_rf_source_data),             //        in.data
		.in_valid          (motor_ip_avalon_slave_agent_rf_source_valid),            //          .valid
		.in_ready          (motor_ip_avalon_slave_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (motor_ip_avalon_slave_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (motor_ip_avalon_slave_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (motor_ip_avalon_slave_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (motor_ip_avalon_slave_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (motor_ip_avalon_slave_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (motor_ip_avalon_slave_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (motor_ip_avalon_slave_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
		.csr_address       (2'b00),                                                  // (terminated)
		.csr_read          (1'b0),                                                   // (terminated)
		.csr_write         (1'b0),                                                   // (terminated)
		.csr_readdata      (),                                                       // (terminated)
	...
	nios_system_mm_interconnect_0_router_002 router_003 (
		.sink_ready         (motor_ip_avalon_slave_agent_rp_ready),           //      sink.ready
		.sink_valid         (motor_ip_avalon_slave_agent_rp_valid),           //          .valid
		.sink_data          (motor_ip_avalon_slave_agent_rp_data),            //          .data
		.sink_startofpacket (motor_ip_avalon_slave_agent_rp_startofpacket),   //          .startofpacket
		.sink_endofpacket   (motor_ip_avalon_slave_agent_rp_endofpacket),     //          .endofpacket
		.clk                (sys_sdram_pll_0_sys_clk_clk),                    //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_system_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (sys_sdram_pll_0_sys_clk_clk),                      // in_clk_0.clk
		.in_rst_0_reset (nios2_gen2_0_reset_reset_bridge_in_reset_reset),   // in_rst_0.reset
		.in_0_data      (motor_ip_avalon_slave_agent_rdata_fifo_src_data),  //     in_0.data
		.in_0_valid     (motor_ip_avalon_slave_agent_rdata_fifo_src_valid), //         .valid
		.in_0_ready     (motor_ip_avalon_slave_agent_rdata_fifo_src_ready), //         .ready
